/*
	...
	create a index.html with the code:
...
<body>
	<div>
		<canvas height="600" width="800" style="border-style: solid;" class="lienzo" id="lienzo">
		</canvas>
	</div>
	<div class="settings">
		
	</div>
	<script type="text/javascript" src="this javascript file"></script>
</body>
</html>
